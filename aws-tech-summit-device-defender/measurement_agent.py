...
if __name__ == '__main__':
    ...
    if not args.dry_run:
        ...
        # creating a custom topic to deliver the customized Device Defender Agent Payload
    ...
    while True:
        ...
        if args.dry_run:
            ...
            if args.format == "cbor":
                ...
                # KG - Also publishing to custom topic to enable custom processing of the DD data
